            ...
            <div class="container">
                <div class="shop-toolbar mb--30">
                    <div class="row align-items-center">
                        ...
                        <form method="GET" action="{{ route('client.shop') }}" id="sortForm">
    <div class="sorting-selection">
        <select name="sort" class="form-control nice-select sort-select" onchange="document.getElementById('sortForm').submit()">
            <option value="default" {{ request()->input('sort') == 'default' ? 'selected' : '' }}>Default Sorting</option>
            <option value="name-asc" {{ request()->input('sort') == 'name-asc' ? 'selected' : '' }}>Sort By: Name (A - Z)</option>
            <option value="name-desc" {{ request()->input('sort') == 'name-desc' ? 'selected' : '' }}>Sort By: Name (Z - A)</option>
            <option value="price-asc" {{ request()->input('sort') == 'price-asc' ? 'selected' : '' }}>Sort By: Price (Low &gt; High)</option>
            <option value="price-desc" {{ request()->input('sort') == 'price-desc' ? 'selected' : '' }}>Sort By: Price (High &gt; Low)</option>
        </select>
    </div>
</form>
                        </div>
                        ...
                        <div class="product-card">
                            <div class="product-grid-content">
                                <div class="product-header">
                                    ...
                                    <h3><a href="{{route('client.product', ['id' => $product->id])}}">{{$product->title}}</a></h3>
                                </div>
                                <div class="product-card--body">
                                    <div class="card-image">
                                        <img src="{{asset($product->main_image($product->images))}}" alt="">
                                        <div class="hover-contents">
                                            <a href="{{route('client.product', ['id' => $product->id])}}" class="hover-image">
                                                <img src="{{asset($product->main_image($product->images))}}" alt="">
                                            </a>
                                            <div class="hover-btns">
                                            <a href="{{ route('add', ['id' => $product->id]) }}" class="single-btn"> <i class="fas fa-shopping-basket"></i></a>
                            ...
                            <div class="product-list-content">
                                <div class="card-image">
                                    <img src="{{asset('front/image/products/product-3.jpg')}}" alt="">
                                </div>
                                <div class="product-card--body">
                                    <div class="product-header">
                                        <a href="" class="author">
                                        ...
                                        <h3><a href="{{route('client.product', ['id' => $product->id])}}" tabindex="0">Qpple cPad with Retina Display
                                                MD510LL/A</a></h3>
                                    </div>
                                    <article>
            ...
            @endforeach
                ...
                "asNavFor": ".product-slider-nav"
                                            ...
                                            <div class="single-slide">
                                                <img src="{{asset('front/image/products/product-details-1.jpg')}}" alt="">
                                            </div>
                                            <div class="single-slide">
                                                <img src="{{asset('front/image/products/product-details-2.jpg')}}" alt="">
                                            </div>
                                            <div class="single-slide">
                                                <img src="{{asset('front/image/products/product-details-3.jpg')}}" alt="">
                                            </div>
                                            <div class="single-slide">
                                                <img src="{{asset('front/image/products/product-details-4.jpg')}}" alt="">
                                            </div>
                                            <div class="single-slide">
                                                <img src="{{asset('front/image/products/product-details-5.jpg')}}" alt="">
                                            </div>
                                        </div>
